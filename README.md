...
--->
I'm a Software Engineering undergrad _@ the University of West Bohemia_ (UWB FAS / ZČU FAV) and a software developer _@ Leuze Engineering_, where I currently work with C#/Blazor.
...
*   Building **Keep Track**, a full-stack personal finance application, which anyone can host at home.
*   Tinkering with and expanding my self-hosted Alpine Linux homelab cluster.
*   Writing code for low-level embedded hardware and microcontrollers.

---
### Off-Screen
If I'm not writing code, then I'm either spending time with family & friends, playing videogames, 3D printing or repairing my Mk1 Yaris.
